	...
	<div class="container" style="margin-bottom: 50px;">
		<div class="row">
			<div class="span6 offset3">
				<h3 class="colored sep_bg">新用户注册</h3>
				<div class="row">
					<form class="form-horizontal" name="registerForm" action="./register" method="post">
						...
						<div class="control-group">
							<label class="control-label" for="inputNickname">昵 称</label>
							<div class="controls">
								<input type="text" id="inputNickname" name="nickname" placeholder="需少于20个字符">
							</div>
						</div>
						<div class="control-group">
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="password" id="inputPassword"  name="rePassword" placeholder="密码">
							</div>
						</div>
						<div class="control-group">
							<div class="controls">

        ...
        <div class="row">
            <div class="span9">
                <div class="row">
                    ...
                    <%
					TbAlbum albumInfo = (TbAlbum)request.getAttribute("albumInfo");
					if(albumInfo!=null){%>
                    <div class="span9 blog_post">
                        <div class="row">
                            ...
                            <div class="span8 block" style="position:relative">
                                <div class="view view-first">
                                    <img src="<%=albumInfo.getCoverImg()%>" alt="" />
                                    <div class="mask">
                                        <a href="<%=albumInfo.getCoverImg()%>" rel="prettyPhoto" class="info"></a>
                                        <a href="#"></a>
                                    </div>
                                </div>
                                <div class="post-date">
                    	...
                    	<%
                    	List<TbComment> commentList = albumInfo.getCommentList();
                        ...
                        <div class="comment">
                            <div class="row">
                            	...
                            	%>
                                <div class="span8 offset1">
                                    <img src="<%=comment.getUserHeadImg()%>" alt="" class="avatar"  style="float:left" width="40px"/>
                                    <div>
                                        <h6><a href="#">迈克杰克逊</a> 评论于 <%=ymdSdf.format(comment.getCreateTime())%></h6> 
                                ...
                                <div class="span8 offset1">
                                 <form class="form">
                                    <textarea type="text" placeholder="Message" rows="2" class="span8"></textarea>

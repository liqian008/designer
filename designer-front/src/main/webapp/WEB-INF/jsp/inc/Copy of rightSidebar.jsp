	...
	<%if(user==null){%>
		...
		<div class="widget-box widget-contact-form">
			...
			<form id="contact-form-widget" method="post" class="clearfix" action="/designer-front/login">
				...
				<input class="contact-submit button" type="button" value="微博登录" onclick="location.href='/designer-front/connectWeibo'"/>
				<input class="contact-submit button" type="button" value="QQ登录" onclick="location.href='/designer-front/connectTencent'"/>
				<input class="contact-submit button" type="submit" value="登 录">
				<input class="contact-submit button" type="button" value="注 册"  onclick="location.href='/designer-front/register'">
			</form>
		</div>
	<%}else{%>
		<div class="widget-box widget-contact-form">
		...
		<form id="contact-form-widget" method="post" class="clearfix" action="/designer-front/login">
			...
			<input class="contact-submit button" type="button" value="个人设置" onclick="location.href='/designer-front/settings'"/>
			 <%if(user.getDesignerStatus()!=null&&user.getDesignerStatus()==ConstService.DESIGNER_APPLY_PASSED){%> 
				<input class="contact-submit button" type="button" value="发布作品"  onclick="location.href='/designer-front/settings?op=publisher'"/>
				<!--  
				<input class="contact-submit button" type="button" value="发布设置"  onclick="location.href='/designer-front/settings?op=shareSettings'"/>
				 -->
			<%}else{%>
				<input class="contact-submit button" type="button" value="申请设计师"  onclick="location.href='/designer-front/settings?op=designerApply'"/>
			<%}%>
			<input class="contact-submit button" type="button" value="注 销" onclick="location.href='/designer-front/logout'"/>

...
<div class='widget-box widget-flickr'>
	<div class='content-title'>
		<h4 class='widget-title'>热门作品辑</h4>
	</div>
	
	
	
	<div class='flickr-wrap clearfix' id="slideHotAlbumsContainer">
...
function fallLoad(){
	$.get('/designer-front/hot/albums.json', function(data) {
		var result = data.result;
		if(result==1){
			$("#slideHotAlbumsContainer").append(data.data.html);
		}else{
			alert("error");
		}
	});

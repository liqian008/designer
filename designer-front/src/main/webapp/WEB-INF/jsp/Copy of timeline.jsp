                    ...
                    <div class="container">
                        <div class="row-fluid">
                            <div class="portfolio-wrapper portfolio-four">
                                ...
                                <article class="portfolio-item ecofriendly">
                                    <a class="portfolio-single-link" href="/designer-front/album?id=<%=album.getId()%>">
                                        <img src="<%=album.getCoverImg()%>"/>
                                    </a>
	                                <div class="content-wrap">
	                                    <a href="#"><h4><%=album.getTitle()%></h4></a>
	                                    <ul>
	                                        <li><span>标 签:&nbsp;</span>翡翠, 珠宝, 玉石</li>
	                                        <li><span>价 格:</span>1w~2w</li>
	                                        <li><span>111 评论 / 33 收藏 / 3 喜欢</span></li> 
	                                    </ul>
	                                </div>
                                </article>

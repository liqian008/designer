			                                    ...
			                                    <li class="clearfix">
			                                        ...
			                                        <div class="blogpost-content">
			                                            ...
			                                            <div class="blogpost-date">
			            									...
			            									if(hasFollowed){
			            									%>
			                                            	<a href="/designer-front/unfollow?uid=<%=follow.getFollowId()%>" class="button button-small button-white">取消关注</a>
			                                            	<%}else{%> 
			                                            	<a href="/designer-front/follow?uid=<%=follow.getFollowId()%>" class="button button-small button-green">关注</a>
			                                            	<%}%>
			                                            </div>
			                                        </div>
			                                    </li>

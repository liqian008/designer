                        ...
                        <section class="content span6 offset3">
							<div class="shortcode-tabs">
							    <ul class="tabs-nav tabs clearfix">
							        <li class="active"><a class="button button-white" href="#tab1" data-toggle="tab">发布微博</a></li>
							    </ul>
							     
							    <div class="tab-content">
							        <div class="tab-pane active" id="tab1">
							        	<div class="content-title">
											<h4 class="widget-title">微博内容</h4>
										</div>
										<form id="contact-form-widget" method="post" class="clearfix"
											action="/designer-front/publish">
											<div class="input-container">
												<input type="text" class="contact-form-name" name="content"
													value="content"
													onfocus="if(this.value=='Your Name')this.value='';"
													onblur="if(this.value=='')this.value='Your Name';" /> <i
													class="icon-user"></i>
											</div>
											<input class="contact-submit button" type="submit" value="发 布">
										</form>
							        </div>

...
<body class="body-background"
	style="background-image: url(./img/backgrounds/bg3.jpg);">
		...
		<div class="page">
			...
			<div class="main fullwidth">
				<section class="content">
							...
							<article class="blog-item span3">
								<div class="blog-post-image-wrap">
									<a class="blog-single-link"
										...
										src="<%=album.getCoverLargeImg()%>" alt="Portfolio Image">
									</a>
								</div>
								<div class="content-wrap span9">
									...
									<ul>
										...
										<li><%=album.getBrowseCount()%>&nbsp;浏览&nbsp;/&nbsp; <%=album.getCommentCount()%>&nbsp;评论&nbsp;/&nbsp;
											<%=album.getFavoriteCount()%>&nbsp;收藏&nbsp;</li>
									</ul>
								</div>
					...
					<input type="hidden" id="albumTailId" name="albumTailId" value="0" />
	...
	<script>
    	...
    	$('#moreAlbumsBtn').click(function(){
    		var jsonData = {'albumTailId' : $("#albumTailId").val()};
    		$.post('/designer-front/moreAlbums.json', jsonData, function(data) {
    			...
    			$("#albumTailId").val(nextTailId);
    			if(nextTailId<=0){//隐藏按钮

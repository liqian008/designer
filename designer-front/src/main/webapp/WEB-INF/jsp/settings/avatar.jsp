...
<!--[if IE 8]>
	...
	<link rel="stylesheet" href="<%=contextPath%>/css/jcrop/jquery.Jcrop.css?v=${version}">
	<script src="<%=contextPath%>/js/jcrop/jquery.Jcrop.js?v=${version}"></script>
									...
									<div class="tab-pane widgets-light active" id="avatar">
										<div class="widget-box widget-wrapper-form">
											...
											<script type="text/javascript"
												src="<%=contextPath%>/faustCplus/swfobject.js?v=${version}"></script>
											<script type="text/javascript">

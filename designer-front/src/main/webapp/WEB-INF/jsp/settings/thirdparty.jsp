...
<script
	src="<%=contextPath%>/js/vendor/modernizr-2.6.1-respond-1.1.0.min.js?v=${version}"></script>
						...
						<section class="content span9">
							...
							<div class="shortcode-tabs shortcode-tabs-vertical clearfix">
								<ul class="tabs-nav tabs clearfix span3">
									<jsp:include
										page="./settingsTabInc.jsp?settingsMenuFlag=thirdparty"></jsp:include>
								</ul>
								<div class="tab-content span9">
									<div class="tab-pane widgets-light active" id="info">
										<div class="widget-box widget-wrapper-form">
											<form class="widget-form" method="post" class="clearfix" action="#">
												<div class="content-title">
													<h4>第三方账户绑定</h4>
												</div>
												...
												<div class="infobox info-warning info-warning-alt clearfix">
													...
													<div class="infobox-wrap">
														<h4>小贴士：</h4>
														<p>
															开启同步设置后，设计师发布专辑时将自动同步到微博，建议设计师打开该项设置
														</p>
													</div>
												</div>
												<%}%>
												...
												<div class="row-container clearfix">
													...
													<div class="row-right">
														...
														<%if (wbBound) {%>
														<input type="checkbox" name="sync2Weibo" value="1"
															<%=wbToken.getSyncAlbum() != null && wbToken.getSyncAlbum() == 1 ? "checked='checked'" : ""%> />发布作品时同步到Sina微博
														<%}%>
													</div>
												</div>

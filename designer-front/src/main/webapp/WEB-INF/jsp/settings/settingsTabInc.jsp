...
<li <%=getActiveStr("publisher", op)%>><a class="button button-white" href="./settings.art?op=publisher">发布作品</a></li>
<li <%=getActiveStr("flowerers", op)%>><a class="button button-white" href="./settings.art?op=flowers">关注我的人</a></li>
<li <%=getActiveStr("designerInfo", op)%>><a class="button button-white" href="./settings.art?op=designerInfo">设计师基本信息</a></li>
<li <%=getActiveStr("shareSettings", op)%>><a class="button button-white" href="./settings.art?op=shareSettings">分享设置（强烈推荐）</a></li>
<%}else{%>

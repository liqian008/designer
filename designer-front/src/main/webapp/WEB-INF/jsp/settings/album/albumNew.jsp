...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet"href="<%=contextPath%>/uploadify/uploadify.css?v=${version}">
                                <!--[if IE 8]>
        ...
        <script src="<%=contextPath%>/uploadify/jquery.uploadify.min.js?v=${version}" type="text/javascript"></script>
   ...
   <!--  <script src="<%=contextPath%>/js/jquery.tweet.js?v=${version}"></script>  -->
    ...
    <script src="<%=contextPath%>/js/validate.js?v=${version}"></script>

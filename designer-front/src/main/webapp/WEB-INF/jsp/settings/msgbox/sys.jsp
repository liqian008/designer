                            ...
                            <div class="shortcode-tabs shortcode-tabs-vertical clearfix">
                                ...
                                <div class="tab-content span9">
                                    <div class="tab-pane widgets-light active" id="inbox">
												...
												<li class="message" id="li-message-<%=i%>"><div
													...
													<div class="message-avatar">
														<div class="message-author vcard">
															<img src="/designer-front/img/icon/icon_<%=message.getMessageType()%>.png"/>
														</div>
													</div>
			                            ...
			                            <%=PagingUtil.getPagingHtml(messagePagingData, "/designer-front/settings/msgbox/sys")%>

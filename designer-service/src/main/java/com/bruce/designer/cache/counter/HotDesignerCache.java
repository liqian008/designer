...
public class HotDesignerCache extends AbstractHotCache{
    ...
    public long incrBrowseScore(int id) {
		return incrScore(id, ConstScoreWeight.SCORE_USER_BROWSE);
	}

	@Override
	public long incrLikeScore(int id) {
		return incrScore(id, ConstScoreWeight.SCORE_USER_LIKE);
	}

	@Override
	public long incrCommentScore(int id) {
		return incrScore(id, ConstScoreWeight.SCORE_USER_COMMENT);
	}

	@Override
	public long incrFavoriteScore(int id) {
		return incrScore(id, ConstScoreWeight.SCORE_USER_FAVORITE);
	}
	
	@Override
    public long reduceBrowseScore(int id) {
		return incrScore(id, 0-ConstScoreWeight.SCORE_USER_BROWSE);
	}

	@Override
	public long reduceLikeScore(int id) {
		return incrScore(id, 0-ConstScoreWeight.SCORE_USER_LIKE);
	}

	@Override
	public long reduceCommentScore(int id) {
		return incrScore(id, 0-ConstScoreWeight.SCORE_USER_COMMENT);
	}

	@Override
	public long reduceFavoriteScore(int id) {
		return incrScore(id, 0-ConstScoreWeight.SCORE_USER_FAVORITE);
	}

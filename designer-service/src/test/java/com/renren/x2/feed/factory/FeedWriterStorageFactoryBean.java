 ...
 */
public class FeedWriterStorageFactoryBean extends FeedWriterStorageInterceptor implements FactoryBean, InitializingBean,
        BeanClassLoaderAware {

    private ClassLoader beanClassLoader = ClassUtils.getDefaultClassLoader();

    private Class<?> businessInterface = IFeedWriterStorage.class;

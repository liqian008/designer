...
public class PaginationPlugin extends PluginAdapter {
	...
	public boolean modelExampleClassGenerated(TopLevelClass topLevelClass,
		...
		addLimit(topLevelClass, introspectedTable, "rowCount");
	...
	public boolean sqlMapSelectByExampleWithoutBLOBsElementGenerated(
		...
		isNotNullElement.addAttribute(new Attribute("property", "limit")); //$NON-NLS-1$ //$NON-NLS-2$
	...
	public static void generate() {
		String config = PaginationPlugin.class.getClassLoader()
				.getResource("generatorConfig4java.xml").getFile();

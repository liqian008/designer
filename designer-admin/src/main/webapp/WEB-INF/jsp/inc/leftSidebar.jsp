		...
		<div id="sidebar">
			...
			<div class="sidebar-tabs">
		        <ul class="tabs-nav two-items">
		            <li><a href="index.html#general" title=""><i class="icon-reorder"></i></a></li>
		            <li><a href="index.html#stuff" title=""><i class="icon-cogs"></i></a></li>
		        </ul>
		        ...
		        <div id="general">
			        ...
			        <div class="sidebar-user widget">
			            ...
			            <a href="index.html#" title="" class="user"><img src="../img/demo/sidebar_user_big.png" alt="" /></a>
			        </div>
			        <!-- /sidebar user -->
			        ...
			        <ul class="navigation widget">
			            <li class="active"><a href="http://demo.kopyov.com/pannonia/index.html" title=""><i class="icon-home"></i>Dashboard</a></li>
			            <li><a href="index.html#" title="" class="expand"><i class="icon-reorder"></i>Form elements<strong>3</strong></a>
			                <ul>
			            ...
			            <li><a href="index.html#" title="" class="expand"><i class="icon-tasks"></i>Components<strong>4</strong></a>
			                <ul>
			            ...
			            <li><a href="index.html#" title="" class="expand"><i class="icon-warning-sign"></i>Error pages<strong>6</strong></a>
			                <ul>
	                    ...
	                    <li><a href="index.html#" title="" class="expand"><i class="icon-indent-right"></i>Menu levels<strong>3</strong></a>
			                <ul>
			                    <li><a href="index.html#" title="">Link</a></li>
			                    <li><a href="index.html#" title="" class="expand">Link with submenu</a>
					                <ul>
					                    <li><a href="index.html#" title="">Lorem ipsum</a></li>
					                    <li><a href="index.html#" title="">Dolor sit amet</a></li>
					                </ul>
			                    </li>
			                    <li><a href="index.html#" title="">Link</a></li>
			                </ul>
	                    </li>
			            <li><a href="index.html#" title="" class="expand"><i class="icon-sitemap"></i>Page layouts<strong>3</strong></a>
			                <ul>
